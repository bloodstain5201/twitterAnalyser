...
consumer_key = "3KGeV8SnvAFBVtxM3FEUKvB5M"
consumer_secret = "Wa9KwIpzZmbKhrjiDTJFtoqnvDisAqrNOheVVfJ2OIBvzJjje3"
access_token = "1477721022862270465-OoZjhHAlNPJYtHXS35WOqHqWa31oEF"
access_token_secret = "COp2B6y1K4YNbZvw2na1JW6vXTfJJtMvai8NsxKDfYjP7"
...
def profile_hashtag_analyzer(keyword):
  if keyword.startswith("#"):
    tweets = []
    for tweet in tweepy.Cursor(api.search_tweets, q="{} -filter:retweets".format(keyword),tweet_mode='extended',lang="en",since="2020-01-31", until="2020-02-06").items(10):
